...
function mockUser(overrides?: Partial<import('../../core/models/api.types').UserResponse>): import('../../core/models/api.types').UserResponse {
  return { id: crypto.randomUUID(), tenantId: 't1', username: 'jperez', email: 'jperez@test.com', role: 'USER', organizationId: 't1', organizationName: 'Test', organizations: [], ...overrides };
}
